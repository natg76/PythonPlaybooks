...
url2 = 'https://s3.amazonaws.com/assets.datacamp.com/production/course_1606/datasets/winequality-white.csv'

# Save file locally
urlretrieve(url2, 'winequality-white.csv')
...
# Print the sheetnames to the shell - sheet names are part of keys
print(xl.keys())
...
## Import using request package (instead of urllib)
